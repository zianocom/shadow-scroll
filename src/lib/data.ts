...
const articles: Article[] = [
  {
    ...
    excerpt: "In 1888, a new terror stalks London's fog-lit streets. It leaves no marks, only a face frozen in fear and a single black feather. This isn't a man. It's an echo from another dimension.",
    content: `
  ...
  },
  {
    ...
    excerpt: 'A deep-space freighter goes silent after a single, blood-curdling scream. The rescue crew finds a pristine ship, a half-eaten meal... and a \'cargo\' that isn\'t just listening, it\'s deleting the crew from existence, one memory at a time.',
    content: `
  ...
  },
  {
    ...
    excerpt: 'Nine hikers found dead in the snow, their tent ripped open from the inside. Some have impossible injuries, as if crushed by an invisible force, one is missing her tongue. The file says \'a compelling natural force.\' The file lies.',
    content: `
  ...
  },
  {
    ...
    excerpt: 'An entire colony of 115 people disappeared from the New World, leaving only one clue: the word "CROATOAN" carved into a tree. Was it their destination, or the name of what devoured them?',
    content: `
