...
const articles: Article[] = [
  {
    ...
    content: `
      <p>The year is 1888. London is a city holding its breath, still reeling from the Ripper's SAVAGE spree. But as the autumn fog thickens, a new, more insidious terror begins to creep through the gaslit streets. This is not a story of a man with a knife. This is the story of a presence that doesn't kill. It ERASES.</p>
      
      <h2>The Feather and the Fear</h2>
      <p>The gas lamps of Whitechapel flickered, casting long, dancing shadows that played tricks on the eyes. For Inspector Frederick Abberline of Scotland Yard, every shadow seemed to hold a secret, every gust of wind a ghostly whisper. He was hunting a specter, a killer the press had dubbed 'The Whispering Shadow,' and it was a chase that would push him to the very brink of sanity.</p>
      <p>The killings began subtly, a series of bizarre and unconnected deaths that baffled the medical examiners. The first victim was a dockworker, found slumped in a grimy alley, his eyes wide with a horror that no mortal threat could explain. The second, a week later, a wealthy socialite discovered in her locked Mayfair mansion, untouched, yet her face was a MASK of petrified terror. There were no marks of violence, no signs of struggle, no poison. The only thing connecting the victims was the look of pure, unadulterated FEAR frozen on their faces, and a single, impossible object left behind: a raven-black feather, resting softly on their chests as if it had just floated down from a passing nightmare.</p>
      
      <h2>An Unseen Predator</h2>
      <p>Scotland Yard was PARALYZED. How do you hunt a phantom? The only clue was the testimony of those who lived nearby—chillingly consistent accounts of a sibilant whisper that seemed to come from nowhere and everywhere at once, a sound like dry leaves skittering across pavement, just moments before a single, sharp scream would curdle the night air. Then, only a SUFFOCATING silence.</p>
      ...
      <p>But Abberline, having stood in the dead rooms where the air felt unnaturally cold and heavy, knew this was no simple fright. It was the stillness of a place where a SOUL had been violently scoured from existence.</p>
      
      <h2>The Ashen Veil</h2>
      <p>Abberline’s official investigation hit a wall of cold, hard logic. Unofficially, his obsession led him into the city's underbelly, from the opulent parlors of the aristocracy to the squalid opium dens of the East End. He unearthed whispers of a secret society, 'The Ashen Veil,' a cabal of influential men who dabbled in the occult. These were not mere enthusiasts; they were London's elite—politicians, artists, industrialists—consumed by a desperate fear of their own mortality. They sought to summon a being they believed was an angel of death, an entity from beyond the veil they called 'The Collector.'</p>
      <p>They had succeeded, but the ritual was FLAWED. The incantation was misspoken, a sigil drawn imperfectly. They hadn't opened a clean doorway; they had shattered a MIRROR, and a sliver of the entity's consciousness had bled through into their world. What they had unleashed was not an angel of judgment, but a paradox walking, a SHARD of pure, malevolent chaos. It was an echo of hunger, a Whispering Shadow now drifting untethered through the labyrinthine city. It wasn't killing for pleasure or purpose. It was simply HARVESTING, drawn to the brightest sparks of life, only to extinguish them and leave behind nothing but a cold, empty vessel and a single black feather—a calling card from a dimension of absolute nothingness.</p>
      
      <h2>A Race Against Nothingness</h2>
      <p>For Abberline, it was now a race against time, a desperate attempt to unravel the corrupted ritual and find a way to banish the shadow before it consumed the very soul of London, one terrified whisper at a time. This was a hunt not for a man, but for a concept given form, a walking, whispering void. The investigation took Abberline to the British Museum's forbidden archives, where a reclusive scholar named Dr. Alistair Finch, a man who smelled of old paper and forgotten lore, confirmed his worst fears. The feather was a marker, a sign of 'soul-theft.' The entity was not merely killing; it was feeding. And with each soul it consumed, it grew stronger, its whispers becoming clearer, its presence more defined. It was learning.</p>
      <p>The final pages of the Ashen Veil's grimoire were missing, torn out. They contained the incantation for banishment. Abberline realized with dawning horror that the society hadn't just summoned the entity; one of them was now its accomplice, its high priest in the material world, gathering the missing pages to grant the shadow a permanent anchor. The Inspector was no longer just a hunter. He was a potential victim, his own vibrant, determined soul a beacon in the London fog. The whispers started to coalesce around him, no longer just a skittering of leaves, but a voice, his own voice, speaking his deepest fears into the night. The game had changed. The shadow was no longer just whispering. It was calling his name.</p>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <p>Blackwood Manor wasn't merely abandoned; it was a place surgically removed from time. For a hundred years it has stood on its lonely hill, a STATUE of silent tragedy. They say the Blackwood family vanished in 1899, but that's a lie. They weren't lost. They were ERASED.</p>
      ...
      <h2>The Echo Game</h2>
      <p>As he ventured deeper, the house began to remember. A floorboard creaked upstairs, though he was alone. A faint, lilting melody, like a forgotten music box, drifted from the nursery. Then he found it, tucked away in a secret compartment of a writing desk: the leather-bound journal of Elara, the youngest Blackwood daughter. Her childish script started with tales of ponies and garden parties, but it slowly descended into a spiral of FEAR.</p>
      <blockquote>"Father calls it 'The Echo Game'. We must hide. We must be silent. The Seeker doesn't use its eyes."</blockquote>
      <p>The rules were chillingly simple and maddeningly vague. <i>Rule 1: When the clock strikes midnight, find your shadow. Rule 2: Never hide in the same place twice. Rule 3: The Seeker hears your thoughts. Rule 4: If it finds you, you must not scream.</i> The final entry, dated the night they disappeared, was a frantic, barely legible scrawl. "The game is real. He is not my father anymore. The Seeker is wearing his skin. It's smiling. We must not make a sound. We must not..." The sentence ends there, the page stained with a dark, flaky substance. Not ink. It was dried BLOOD.</p>
      
      <h2>The Seeker in the Glass</h2>
      <p>Suddenly, a deafening GONG echoed through the house. The grand clock in the hall, its pendulum still for a hundred years, struck midnight. Alistair's blood ran cold. From the darkened hallway, a child's giggle—playful, yet utterly soulless—drifted towards him. The game had begun again. He was no longer a historian exploring a mystery. He was a player. The manor itself was the board, a labyrinth of decaying grandeur where the echoes of the past were hungry.</p>
      <p>The journal mentioned another rule, crossed out and rewritten over and over. <i>Rule 5: Don't look in the mirrors after the first chime.</i> Alistair, now crouched behind a rotting velvet curtain in the ballroom, could see his own terrified reflection in a dozen tarnished mirrors. In the reflection, he wasn't alone. A tall, impossibly thin figure stood behind him, its limbs too long, its head tilted at an unnatural angle. It was wearing the tattered remains of what looked like Lord Blackwood's suit. The figure raised a long, skeletal finger and pressed it to its smiling lips, a gesture of silence. It wasn't in the room with him. It was ONLY in the mirrors. The Seeker didn't just hear thoughts; it saw possibilities, it saw fear. Alistair realized the game wasn't about hiding his body; it was about hiding his MIND. The manor was a psychic labyrinth, and he was the rat. The child's giggle echoed again, this time from right behind him. He spun around. Nothing. Just the suffocating silence. The game was far more complex than he'd imagined. And the house was a CHEATER.</p>
    `,
    imageId: 'post-1',
    featured: false,
  },
  {
    ...
    content: `
      ...
      <p>The deep-space freighter 'Odyssey,' with a crew of twenty souls and a cargo of invaluable helium-3, had gone silent in the desolate expanse of the Kuiper Belt. The salvage vessel 'Harbinger,' captained by a grizzled veteran named Eva Rostova, was dispatched to investigate. They found the 'Odyssey' drifting, not dead, but waiting. It was pristine. There were no hull breaches, no signs of a firefight, no micrometeoroid impacts. It was eerily, unnaturally PERFECT.</p>
      <p>When they boarded, the sense of wrongness was immediate and suffocating. The ship's internal gravity was stable, life support humming contentedly. In the mess hall, half-eaten meals sat on the tables, coffee still warm in their bulbs. In the crew quarters, personal logs were left open, displaying unfinished messages to loved ones back on Earth. But the crew was GONE. Not dead. GONE. Vanished from between one heartbeat and the next.</p>
      
      <h2>Unraveling the Crew</h2>
      <p>Rostova's team swept the ship, deck by deck. Every corner was a portrait of interrupted life. But there were no bodies, no blood, no evidence of any struggle. The ship's logs were the first clue. The final entry from Captain Hayes was not in the official flight record but scrawled on a personal datapad.</p>
      <blockquote>"It's not killing us. It's not taking us. It's UNRAVELING us. Piece by piece. The memory of my mother's face is gone. Then the color blue. It's taking the pieces. Oh God, it's..."</blockquote>
      <p>The log ends there. Then they found the cargo bay. The manifest listed raw helium-3 isotopes. But what lay in the center of the vast hold was not a standard containment field. It was a latticework of impossible geometry, a floating sculpture of obsidian and light that seemed to fold in on itself. And all over the walls of the bay, burned into the durasteel, were strange, non-Euclidean symbols. They glowed with a faint, sickly violet light, and the 'Harbinger's' sensors screamed with radiation warnings that made no sense.</p>
      
      <h2>The Collector</h2>
      <p>The salvage crew started reporting... disturbances. A tech saw his reflection in a console, only for the reflection to turn and smile at him before vanishing. The ship's corridors seemed to stretch and compress. Voices whispered from empty rooms. They were seeing glitches in the fabric of their own reality.</p>
      <p>Rostova finally understood. The 'cargo' was a dimensional artifact. A 'Collector,' as some fringe theories called it. It didn't travel through space; it punctured it. And it wasn't dormant. It was LISTENING. The 'Odyssey' hadn't just stumbled upon it; their deep-range scans had woken it from its eons-long slumber. That final, desperate transmission wasn't a warning. The scream was the key, the specific frequency that fully activated the device. The artifact wasn't just a thing; it was a conscious, predatory system. It didn't consume matter. It consumed information, experience, consciousness itself. It had unraveled the crew of the 'Odyssey,' deconstructing them concept by concept, memory by memory, until nothing was left.</p>
      
      <h2>Becoming Data</h2>
      <p>The 'Harbinger' crew weren't a rescue mission. They were the second course, drawn in by a lure of salvage and profit. The artifact was awake. And it was hungry for new stories to tell itself. The question was no longer what happened to the 'Odyssey.' The question was, what fundamental part of you will it erase first? Your name? Your past? The very idea of 'home'?</p>
      <p>One of Rostova's crewmen, a young engineer named Jax, began to hum a tune—a complex, discordant melody. When asked what it was, he looked confused. "It's just... in my head. Always has been." But the ship's computer, analyzing the tune, identified it as the inverse of the recursive pattern from the 'Odyssey's' final static burst. The artifact wasn't just erasing. It was REPLACING. It was overwriting their personalities with its own alien consciousness. Rostova sealed the cargo bay, but it was too late. The ship's computer began displaying the symbols from the cargo bay on every screen. The 'Harbinger' was no longer her ship. It was a cage. A processing plant. And she and her crew were no longer human. They were becoming data. They were becoming echoes.</p>
    `,
    imageId: 'post-2',
    featured: false,
  },
